      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="bg-slate-100/50 dark:bg-slate-800/50 rounded-3xl p-6 space-y-6">
          ...
          <button
            ...
            className="w-full py-4 bg-indigo-500 text-white rounded-2xl text-sm font-black shadow-xl mt-2 active:scale-95 transition-all"
          >
            保存到数据库（前台立即生效）
          </button>
          <button
          ...
          <p className="text-[10px] text-slate-500 leading-relaxed">
            歌曲 ID 为网易云数字 ID（打开歌曲页，地址栏里的数字）。播放由 Meting 接口提供。
          </p>
        </div>
      </div>
    </motion.section>
